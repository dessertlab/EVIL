...
python $SRC_DIR/utils/preproc/seq2seq_output_to_code.py $SRC_DIR/model/finetuned_model/$dataset_str/test_1.hyp $SRC_DIR/processed_dataset/$dataset_str-test.json.seq2seq $SRC_DIR/model/eval/${dataset_str}_test_output.json $dataset_str
