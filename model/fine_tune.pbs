...
#
### TODO: Specify queue to run
#PBS -q ENTER_QUEUE NAME
### Set the job name
#PBS -N ShellBe_gpu
### Specify the # of cpus and gpus for your job.
#PBS -l nodes=1:ppn=1:gpus=2,mem=8GB
#PBS -l walltime=301:01:01
### pass the full environment
#PBS -V
#PBS -o job_logs/$PBS_JOBID.o 
#PBS -e job_logs/$PBS_JOBID.e
#
# ===== END PBS OPTIONS =====
