...
lang=Shellcode_IA32 #change when changing dataset version (i.e. _fixed, _intent_parser) etc 
lr=5e-5
batch_size=32 # or 64
beam_size=10
source_length=256
...
train_file=$data_dir/assembly-train.json.seq2seq #change when changing dataset
dev_file=$data_dir/assembly-dev.json.seq2seq #change when changing dataset
test_file=$data_dir/assembly-test.json.seq2seq #change when changing dataset
eval_steps=320 
train_steps=2800 
